    ...
    module OKL
      class Sku < CatalogTransformer::Base
        ...
        exclude :eph_tree_node_id, :ecom_status, :rollup_type_cd, :rollup_type_name,
                ...
                # :units_sold_last_1_week_online, :units_sold_last_4_weeks_online, :units_sold_last_8_weeks_online, :units_sold_last_52_weeks_online,
                ...
                :personalization_cd, :personalization_name, :tbs_blocked_start_date, :tbs_blocked_end_date,
                :vdc_shipping_cutoff_offset, :web_copy_complete_status, :color_group_name, :color_group_cd,
