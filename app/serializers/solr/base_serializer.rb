module SOLR
  class BaseSerializer < ActiveModel::Serializer
    ...
    stub_attributes :available_in_ca, :clearance_status, :concept_eligibility, :contribution_margin_percent,
                    ...
                    :inventory_store_total, :inventory_vdc_total, :jda_status, :line_of_business, :ltl_flag,
                    :personalized, :product_type, :size, :tbs_blocked, :web_enabled_date, :bbby_site_nav_tree_node_id,
