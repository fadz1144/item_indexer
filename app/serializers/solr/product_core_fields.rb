module SOLR
  ...
  class ProductCoreFields
    SHARED_FIELDS = [
      ...
      # contribution margin
      { name: 'min_contribution_margin_per_unit_amount_cents', type: 'int', indexed: true, stored: true },
      { name: 'max_contribution_margin_per_unit_amount_cents', type: 'int', indexed: true, stored: true },
      { name: 'min_contribution_margin_per_unit_percent', type: 'float', indexed: true, stored: true },
      { name: 'max_contribution_margin_per_unit_percent', type: 'float', indexed: true, stored: true },
